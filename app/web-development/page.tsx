    ...
    <>
      ...
      <div className="page-wrapper page-enter">
        ...
        <div className="projects-page">
          <Link href="/" className="back-link" id="back-to-home-wd">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
          ...
          <header className="projects-header">
            <div className="projects-header-icon webdev">💻</div>
            <h1>Web Development</h1>
            <p>
              Proyek-proyek pengembangan web modern menggunakan framework terkini,
              responsive design, REST API, dan full-stack applications.
            </p>
          </header>
          ...
          <div className="projects-grid">
            ...
            <div className="projects-empty">
              ...
              <p>
                Proyek-proyek Web Development akan ditambahkan di sini.
                <br />
